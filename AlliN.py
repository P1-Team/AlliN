...
class infoscan:
    ...
    @staticmethod
    def fhtmlencode(lens, mname, api):
        """
        conversion result to html language(failed message)
        lens: length of message box (totally 12)
        mname: name of method
        api: api url of method
        """
        failMesg = """
    ...
    def vtdns_records(self):
        """
        dict key info:
        iterm: number of records
        records<num>: each record
        {
        type: type of dns resolution (A: Point of domain. NS: namerserver  TXT: note of information,spf  MS: email records)
        value: type of value
        ttl: ttl
        priority: priority
        }
        ...
        for i in range(3):
            try:
                ...
                dns_records = {}
                iterm = 1
                for recordses in r["dns_records"]:
                    result = {}
    ...
    def vt_resolutions(self):
        """
        dict key info:
        iterm: number of resolutions
        resolved<num>: information of resolved
        {
            last_resolved: time of last resolved
        ...
        for i in range(3):
            try:
                ...
                resl = {}
                iterm = 1
                for resloveds in r["resolutions"]:
                    name = "resolved" + str(iterm)
                    solution = {}
                    solution["last_resolved"] = resloveds["last_resolved"]
                    solution["ip_address"] = resloveds["ip_address"]
                    iterm += 1
                    resl[name] = solution
                resl["iterm"] = iterm - 1
    ...
    # scan if cnnic"s information
    def cnnicinfo(self):
        """
        dict key info:
        ipv4 : address of ipv4
        desc_company: describe of company
        address: Correspondence address
        person_num: numbers of personal information
        persons<num> : each person"s detail
        {
            name: name of person
    ...
    def whoisinfo(self):
        """
        dict key info:
        infos_num: number of information
        whoinfo<num>:each detail information
        {
            phone: phone of register of domain
    ...
    # passivetotal info scan
    def passivetotalinfo(self):
        """
        riskiq scan informations
        risk_nums: numbers results of riskqi scan
        risk_info<num>:each detail of result of riskqi scan
        {
            telephone: phone of register
            name: name
            email: email
        }
        """
    ...
    def getCseg(self):
        """
        fofa_cloud: check  whether ip from result of fofa  is CDN. None is not
        shodan_cloud: check whether ip from result of shodan is CDN. None is not
        shodan: result of shodan
        fofa: result of fofa
        """
        try:
            progress()
    ...
    def Getemail(self):
        ...
        for i in range(3):
            try:
                ...
                progress.current += 1
                getemail = {}
                email_url = "https://www.email-format.com/d/{}/#".format(self.domain)
                ho = urllib2.OpenerDirector()
                ho.add_handler(urllib2.HTTPSHandler())
                emailReq = urllib2.Request(email_url)
    ...
    def Getsubdomain(self):
        """
        Get all of submoain result from subdomain class
        """
        progress()
        progress.current += 1
...
class INFOHtml:
        ...
        if getCseg is None:
            ...
            if getCseg["shodan"] is not None:
                ...
                for ips in getCseg["shodan"].keys():
                    shodan_seg += "[ " + ips + "-" + getCseg["shodan"][ips][0] + "] "
            ...
            if getCseg["fofa"] is not None:
                fofa_seg = "fofa: "
                for ips in getCseg["fofa"].keys():
    ...
    def DNS1(infofuc):
        ...
        vtdns_records = infofuc.vtdns_records()
        vtdns_contents = ""
        ...
        if vtdns_records is None:
            ...
            vtdns_contents +="""<div class="col-lg-8">
                    <div class="card m-b-30">
                        <div class="card-body">
                        <h4>vdns records</h4>
                            <div class="alert alert-primary" role="alert"><strong>Successfull!</strong>There are totally %d results</div>
                        <p class="sub-title">%s</p>
                            <details open>
                                <summary>details</summary>
                    <table class="table mb-0 table-hover">%s</table>
                    <p>%s</p>
                            </details>
                    </div>
                </div>
    ...
    @staticmethod
    def DNS2(infofuc):
        # vt resolutions result
        # https://www.virustotal.com/vtapi/v2/domain/report
        vt_resolutions = infofuc.vt_resolutions()
        ...
        if vt_resolutions is None:
            ...
            details = "<tbody>"
            types = """<thead class="thead-default">
                <tr><th>#</th><th>last_resolved</th><th>ip_address</th>
                </tr>
           </thead>
            """
            for iterm in range(totals):
            ...
            vt_resolutions_contents += """<div class="col-lg-4">
                    <div class="card m-b-30">
                        <div class="card-body">
                        <h4>vt resolutions history</h4>
                            <div class="alert alert-primary" role="alert"><strong>Sunccessfull!</strong>There are totally %d results</div>
                        <p class="sub-title">%s</p>
                            <details open>
                                <summary>details</summary>
                    <table class="table mb-0 table-hover">%s</table></details>
                    </div>
                </div>
            </div>
    ...
    def WHOIS1(infofuc):
        ...
        if whoisinfo is None:
            ...
            details = ""
            types = """<thead class="thead-default">
                <tr><th>#</th><th>name</th><th>value</th>
                </tr>
           </thead>
            """
            for iterm in range(totals):
            ...
            whoisinfo_content +="""<div class="col-lg-12">
                    <div class="card m-b-30">
                        ...
                        <h4>whois information</h4>
                            <div class="alert alert-primary" role="alert"><strong>Sunccessfull!</strong>There are totally %d results</div>
                        <p class="sub-title">%s</p>
                        <div class="alert alert-info alert-dismissible fade show" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">x</span></button><strong>Note:</strong>If result has two value. the first information created before change.The other created after change</div>
                            <details open>
                                <summary>details</summary>
                    <table class="table mb-0 table-hover">%s</table></details>
                    </div>
    ...
    def WHOIS2(infofuc):
        ...
        if cnnicinfo is None:
            ...
            for iterm in range(person_num):
                name = "persons" + str(iterm + 1)
                each_person = """<tr>
                   <th scope="row">%d</th>
                   <td>%s</td>
                   <td>%s</td>
            ...
            details += "</tbody>"
            domaininfo = """<div class="alert alert-success mb-0" role="alert">
            <h4 class="alert-heading mt-0 font-18">company information</h4>
            <p>company describe: %s</p>
...
def infoprocess(filename, domain):
    ...
    while True:
        if PYVERSION < "3.0":
            choose = str(raw_input(attention("infoscan") + ">"))
        else:
        ...
        # all scan
        elif choose.upper() == "ALLSCAN":
            modules.append("SEGE")
            modules.append("DNS1")
            modules.append("DNS2")
            modules.append("WHOIS1")
            modules.append("WHOIS2")
            modules.append("WHOIS3")
            modules.append("WHOIS4")
    ...
    # html Headers
    htmlheaders = r"""
    <!DOCTYPE html><html><head><title>Result of AlliN infoscan</title><meta http-equiv="Content-Type  content=”text/html; charset="utf-8″><script src="https://libs.baidu.com/jquery/2.0.0/jquery.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script><link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css" rel="stylesheet" type="text/css"><link href="http://cdn.bootstrapmb.com/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"><script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-treeview/1.2.0/bootstrap-treeview.min.css"></script><script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script><script src="https://cdn.bootcss.com/jquery/3.4.1/core.js"></script><style>.row{margin-top: 20px;}img{width:41px;height:38px;}</style></head>
"""
    htmlheaders += """<body><nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <footer class="page-footer font-small blue" style="background-color: #e3f2fd;margin-top: 20px;">
      <div class="footer-copyright text-center py-3">Support By 
        <a href="#"> AlliN infoscan</a>
      </div>
    </footer>
        </body>
    </html>
