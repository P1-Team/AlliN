...
def swithHeader(options):
    ...
    user_agent = [
        ...
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10; rv:33.0) Gecko/20100101 Firefox/44.0",
        "Mozilla/5.0 (X11; Linux i586; rv:31.0) Gecko/20100101 Firefox/53.0",
        "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:31.0) Gecko/20130401 Firefox/41.0",
        "Mozilla/5.0 (Windows NT 5.1; rv:31.0) Gecko/20100101 Firefox/46.0",
...
def check_cloud_server(ip):
    ...
    # Amazon cloud
    amazon_vps = [(279099648, 279099903), (306288640, 306288895), (877789184, 877835263), (877835520, 877920255), (1146028032, 1146044415)]
